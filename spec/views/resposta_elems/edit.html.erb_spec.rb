...
RSpec.describe "resposta_elems/edit", type: :view do
  let(:resposta_elem) {
    RespostaElem.create!(
  ...
  before(:each) do
    assign(:resposta_elem, resposta_elem)
  end

  it "renders the edit resposta_elem form" do
    render

    assert_select "form[action=?][method=?]", resposta_elem_path(resposta_elem), "post" do
