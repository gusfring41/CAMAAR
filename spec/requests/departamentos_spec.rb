  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Departamento" do
        expect {
          post departamentos_url, params: { departamento: valid_attributes }
    ...
    context "with invalid parameters" do
      it "does not create a new Departamento" do
        expect {
          post departamentos_url, params: { departamento: invalid_attributes }
        }.to change(Departamento, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested departamento" do
        departamento = Departamento.create! valid_attributes
        patch departamento_url(departamento), params: { departamento: new_attributes }
        departamento.reload
    ...
    context "with invalid parameters" do
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        departamento = Departamento.create! valid_attributes
        patch departamento_url(departamento), params: { departamento: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_content)
      end
    end
  end
